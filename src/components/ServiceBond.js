...
//         THIS AGREEMENT is made on the (present date)_ between (Virtusa Consulting Services Private Limited (“Virtusa”)) .A company registered under the Companies Act, 1956 and having its registered office at 34 IT Highway Navallur Chennai.Tamil Nadu 603103 . (Name of the appointee)_ residing at (Address of the employee) __ (Hereinafter called the “Employee”) of the other part.

 

// WHEREAS

// The company is desirous of appointing (Name of the appointee)_ as its (Designation) __ and the Employee has  agreed to on the terms and conditions outlined here below.
...
// <br></br>
// <br></br>
// 1. The said (Name of the appointee) _is hereby appointed as the (Designation) __ of the company and he will hold the said office, subject to the provisions made hereinafter, for the term of (Duration with the organization) _ from the date of this agreement. As a guarantee you are agreed to keep your all-original education certificates with the custody of (Organization Name) __.
// <br></br><br></br>
...
//   <input type="file" id="myFile" name="filename"   onChange={(e) => postDetails(e)}/>
//   <Button  onClick={saveDocuemnts} > Submit </Button>
// </form>
//  </div>
//  <ToastContainer/>
//    </div>
